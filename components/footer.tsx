...
export const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-center bg-zinc-900 text-white">
      <div className="flex w-full max-w-[1440px] items-start justify-between p-24">
        <div className="flex flex-col gap-8">
          ...
          <h6 className="text-sm text-slate-500">
            Deceneuz © {new Date().getFullYear()}. All rights reserved.
          </h6>
        </div>
      ...
      <p className="my-4 text-sm text-slate-600">
        Crafted and coded by Team Quadscript
      </p>
    </footer>
  );
};
